  ...
  renderBebanCard: function(container) {
    ...
    bebanCard.innerHTML = `
      <div class="card-header-with-tips">
        ...
        <button class="circle-tips-btn" data-tips="Masukkan beban ultimit untuk tumpuan kiri, lapangan, dan tumpuan kanan balok.">?</button>
      </div>
  ...
  renderTulanganCard: function(container) {
    ...
    tulanganCard.innerHTML = `
      <div class="card-header-with-tips">
        ...
        <button class="circle-tips-btn" data-tips="Masukkan data tulangan untuk evaluasi balok.">?</button>
      </div>
      <div class="form-grid">
        <div class="field">
          <label>D</label>
